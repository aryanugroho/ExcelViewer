...
public class ToHtml {
 ...
 public void printPage(int sheetIndex) throws IOException {
     try {
         ensureOut();
         if (completeHTML) {
             out.format(
         ...
         if (completeHTML) {
        	 out.format("<br/><a href=\"./view\">Back</a>%n");
             out.format("</body>%n");
             out.format("</html>%n");
         }
     } finally {
 ...
 private void printSheets(int sheetIndex) {
     ensureOut();
